...
public class mainTest {
    ...
    // 合约地址
    public static String linkageRuleAddr;
    public static String registerAddr;
    public static String toolsAddr;
    public static String trustRuleAddr_1;//平台1
    public static String trustRuleAddr_2;//平台2
    public static String userSceneRuleAddr;

    // 成员地址
    public static String userAddr = "0x24602722816b6cad0e143ce9fabf31f6026ec622";//用户地址
    public static String deviceAddr_1 = "0xcd2a3d9f938e13cd947ec05abc7fe734df8dd826";//设备1地址
    public static String deviceAddr_2 = "0xcd2a3d9f938e13cd947ec05abc7fe734df8dd826";//设备2地址
    public static String platAddr_1 = "0xcd2a3d9f938e13cd947ec05abc7fe734df8dd826"; //平台1地址
    public static String platAddr_2 = "0xcd2a3d9f938e13cd947ec05abc7fe734df8dd826"; //平台2地址
    public static StaticArray<Address> addr4 = new StaticArray<>(new Address(platAddr_1),new Address(deviceAddr_1),new Address(platAddr_2),new Address(deviceAddr_2));
    /* 部署合约 */
    ...
    /* 信任规则合约测试 */
    public void trustRuleTest() throws ExecutionException, InterruptedException {
        // 平台1部署信任规则合约
        deploy("TrustRule_1");
    ...
    /* 用户规则合约测试 */
    public void userSceneRuleTest() throws ExecutionException, InterruptedException {
        // 用户1部署用户场景规则合约
    ...
    /* 联动规则合约测试 */
    public void linkageRuleTest() throws ExecutionException, InterruptedException {
        // 平台1部署联动规则合约
        deploy("LinkageRule");
    ...
    /* 联动测试 */
    public void transactionTest() throws ExecutionException, InterruptedException {
        // 通过平台1部署的信任规则合约发起交易
        TrustRule trustRule = TrustRule.load(trustRuleAddr_1, web3j, credentials, gasPrice, gasLimit);
